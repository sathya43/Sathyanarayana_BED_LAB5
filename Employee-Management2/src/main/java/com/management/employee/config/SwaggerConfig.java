...
public class SwaggerConfig {
	...
	public Docket employeeAPI() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("Employee Management API")
				.select().apis(RequestHandlerSelectors.basePackage("com.management.employee.controller")).build()
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Employee Management API").description("Employee Management  API referance for developers")
				...
				.contact(new Contact("Employee Management API", "http://employeemanagement.com", "employeemanagement@gmail.com"))
				.license("Employee Management License").licenseUrl("http://employeemanagement.com").version("1.0").build();
	}
